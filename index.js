...
const startGame = async (chatId) => {
    ...
    await bot.sendMessage(chatId, 'Попытка не пытка, но помни как Юлий проиграл два полцарства', gameOptions);
}
...
const start = () => {
    ...
    bot.on('callback_query', msg => {
        ...
        console.log("бот загадал", chats[chatId]);
        console.log("я нажал", data);
        if(data ==='/again') {
           return startGame(chatId);
        }
