...
const start = () => {
    ...
    bot.on('callback_query', async msg => {
        ...
        if (Number(data) === chats[chatId]) {
            await bot.sendMessage(chatId, `Жулик ты удагал цифру ${chats[chatId]}`);
            return bot.sendSticker(chatId, 'https://tlgrm.ru/_/stickers/32c/096/32c0964b-622b-3372-830a-35b839713818/3.webp', againOptions);
        } else {
